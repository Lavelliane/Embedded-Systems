...
__pidataBANK0:
	file	"Z:\3201\Pre-Midterms\LASTRE_TORAL_LE5-2.c"
	line	24
...
;; *************** function _main *****************
;; Defined at:
;;		line 77 in file "Z:\3201\Pre-Midterms\LASTRE_TORAL_LE5-2.c"
...
l1503:	
;LASTRE_TORAL_LE5-2.c: 80: TRISB = 0x00;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	clrf	(134)^080h	;volatile
	line	81
;LASTRE_TORAL_LE5-2.c: 81: PORTB = 0x00;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(6)	;volatile
	line	82
...
l1505:	
;LASTRE_TORAL_LE5-2.c: 82: ADCON1 = 0x80;
	movlw	(080h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l1507:	
;LASTRE_TORAL_LE5-2.c: 85: ADCON0 = 0x41;
	movlw	(041h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(31)	;volatile
...
l1509:	
;LASTRE_TORAL_LE5-2.c: 87: ADIF = 0;
	bcf	(102/8),(102)&7	;volatile
	line	88
	
l1511:	
;LASTRE_TORAL_LE5-2.c: 88: ADIE = 1;
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l1513:	
;LASTRE_TORAL_LE5-2.c: 89: GIE = 1;
	bsf	(95/8),(95)&7	;volatile
	line	90
	
l1515:	
;LASTRE_TORAL_LE5-2.c: 90: PEIE = 1;
	bsf	(94/8),(94)&7	;volatile
	line	91
	
l1517:	
;LASTRE_TORAL_LE5-2.c: 91: GO = 1;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(250/8),(250)&7	;volatile
	line	93
;LASTRE_TORAL_LE5-2.c: 92: for(;;)
	
l49:	
	line	95
;LASTRE_TORAL_LE5-2.c: 93: {
;LASTRE_TORAL_LE5-2.c: 95: }
	goto	l49
...
;; *************** function _ISR *****************
;; Defined at:
;;		line 49 in file "Z:\3201\Pre-Midterms\LASTRE_TORAL_LE5-2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
i1l1475:	
;LASTRE_TORAL_LE5-2.c: 51: GIE = 0;
	bcf	(95/8),(95)&7	;volatile
	line	52
	
i1l1477:	
;LASTRE_TORAL_LE5-2.c: 52: int d_value = 0;
	clrf	(ISR@d_value)^080h
	clrf	(ISR@d_value+1)^080h
	line	53
	
i1l1479:	
;LASTRE_TORAL_LE5-2.c: 53: if(ADIF == 1)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
i1l1481:	
;LASTRE_TORAL_LE5-2.c: 54: {
;LASTRE_TORAL_LE5-2.c: 55: ADIF = 0;
	bcf	(102/8),(102)&7	;volatile
	line	56
	
i1l1483:	
;LASTRE_TORAL_LE5-2.c: 56: d_value = readADC();
	fcall	_readADC
	movf	(1+(?_readADC)),w
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
i1l1485:	
;LASTRE_TORAL_LE5-2.c: 57: float resultOfConversion = (float) d_value * 0.004911;
	movlw	0xec
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftmul@f1)
...
i1l1487:	
;LASTRE_TORAL_LE5-2.c: 58: float formattedResult = round_to_one_decimal(resultOfConversion);
...
i1l1489:	
;LASTRE_TORAL_LE5-2.c: 59: int whole = (int)formattedResult;
...
i1l1491:	
;LASTRE_TORAL_LE5-2.c: 60: float decimal = formattedResult - whole;
	movf	(ISR@formattedResult)^080h,w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftadd@f1)
...
i1l1493:	
;LASTRE_TORAL_LE5-2.c: 64: unsigned int result;
;LASTRE_TORAL_LE5-2.c: 66: result = (whole<< 4) | ((int)(decimal * 10) & 0x0F);
...
i1l1495:	
;LASTRE_TORAL_LE5-2.c: 68: PORTB = result;
...
i1l1497:	
;LASTRE_TORAL_LE5-2.c: 69: }
;LASTRE_TORAL_LE5-2.c: 70: delay(1000);
	movlw	low(03E8h)
	movwf	(delay@cnt)
	movlw	high(03E8h)
	movwf	((delay@cnt))+1
...
;; Defined at:
;;		line 39 in file "Z:\3201\Pre-Midterms\LASTRE_TORAL_LE5-2.c"
;; Parameters:    Size  Location     Type
...
i1l1451:	
;LASTRE_TORAL_LE5-2.c: 40: float rounded_num = round(num * 1000.0);
	movlw	0x0
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(___ftmul@f1)
...
i1l1453:	
;LASTRE_TORAL_LE5-2.c: 41: if(((int)(rounded_num)%100 <= 49))
	movlw	low(064h)
...
i1l1455:	
;LASTRE_TORAL_LE5-2.c: 42: rounded_num = floor(rounded_num);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(round_to_one_decimal@rounded_num),w
	movwf	(floor@x)
...
i1l1457:	
;LASTRE_TORAL_LE5-2.c: 43: else
;LASTRE_TORAL_LE5-2.c: 44: rounded_num = floor(rounded_num);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(round_to_one_decimal@rounded_num),w
	movwf	(floor@x)
...
i1l1459:	
;LASTRE_TORAL_LE5-2.c: 46: return rounded_num/1000.0;
	movlw	0x0
	movwf	(___ftdiv@f2)
	movlw	0x7a
	movwf	(___ftdiv@f2+1)
...
;; *************** function _readADC *****************
;; Defined at:
;;		line 30 in file "Z:\3201\Pre-Midterms\LASTRE_TORAL_LE5-2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;  temp            2    4[COMMON] int 
...
i1l1439:	
;LASTRE_TORAL_LE5-2.c: 32: int temp = 0;
	clrf	(readADC@temp)
	clrf	(readADC@temp+1)
	line	34
	
i1l1441:	
;LASTRE_TORAL_LE5-2.c: 34: temp = ADRESH;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(30),w	;volatile
	movwf	(??_readADC+0)+0
...
i1l1443:	
;LASTRE_TORAL_LE5-2.c: 35: temp = temp << 8;
...
i1l1445:	
;LASTRE_TORAL_LE5-2.c: 36: temp = temp | ADRESL;
	movf	(readADC@temp),w
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
i1l1447:	
;LASTRE_TORAL_LE5-2.c: 37: return temp;
	movf	(readADC@temp+1),w
	clrf	(?_readADC+1)
	addwf	(?_readADC+1)
	movf	(readADC@temp),w
...
;; *************** function _delay *****************
;; Defined at:
;;		line 26 in file "Z:\3201\Pre-Midterms\LASTRE_TORAL_LE5-2.c"
;; Parameters:    Size  Location     Type
;;  cnt             2    0[COMMON] int 
;; Auto vars:     Size  Location     Type
;;		None
...
i1l1435:	
;LASTRE_TORAL_LE5-2.c: 28: while(cnt--);
	goto	i1l1437
